    ...
    return (
        <>
            <section className='h-screen flex flex-col items-center justify-center'>
                <h2 className='text-3xl md:text-5xl font-bold font-archivo'>Page Not Found</h2>
                ...
                <Link to='/' className='text-center text-xl font-semibold uppercase inline-block py-3 px-8 bg-[#769F4F] text-white'>Back to Home</Link>
            </section>
        </>
    );
};
